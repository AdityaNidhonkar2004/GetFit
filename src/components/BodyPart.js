...
const BodyPart = ({ item, setBodyPart, bodyPart }) => {
      ...
      return (
        <>
          <img
            ...
            alt="all"
            className="w-[290px] h-[165px] mt-[50px] rounded-md"
          ></img>
        </>
      );
    } else if (item === back) {
      ...
      return (
        <>
          <img
            ...
            alt="cardio"
            className="w-[290px] h-[250px] mt-[50px] rounded-md"
          ></img>
        </>
      );
    } else if (item === neck) {
  ...
  return (
    <Stack
      ...
      className="text-white hover:scale-105 hover:duration-700 shadow-md  hover:shadow-xl hover:bg-white hover:text-black rounded-xl"
      sx={
        bodyPart === item
          ? {
